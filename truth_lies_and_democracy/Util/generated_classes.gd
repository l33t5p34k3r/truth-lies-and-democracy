...
class StoryGroup:
	...
	func _init(data: Dictionary = {}) -> void:
		...
		if raw_group_id != null:
			group_id = _parse_int(raw_group_id, "StoryGroup.group_id")
		else:
			group_id = 0
		...
		if raw_stories != null:
			stories = _parse_int_array(raw_stories, "StoryGroup.stories")
		else:
			stories = []
	...
	func validate() -> Array[String]:
		...
		if group_id == null:
			errors.append("StoryGroup.group_id is required")
...
class Story:
	...
	func _init(data: Dictionary = {}) -> void:
		...
		if raw_story_id != null:
			story_id = _parse_int(raw_story_id, "Story.story_id")
		else:
			story_id = 0
		...
		if raw_news_headline != null:
			news_headline = str(raw_news_headline)
		else:
			news_headline = ""
		...
		if raw_news_content != null:
			news_content = str(raw_news_content)
		else:
			news_content = ""
		...
		if raw_news_fake != null:
			news_fake = _parse_bool(raw_news_fake, "Story.news_fake")
		else:
			news_fake = false
	...
	func validate() -> Array[String]:
		...
		if story_id == null:
			errors.append("Story.story_id is required")
		...
		if news_fake == null:
			errors.append("Story.news_fake is required")
...
class MediaPostGroup:
	...
	func _init(data: Dictionary = {}) -> void:
		...
		if raw_group_id != null:
			group_id = _parse_int(raw_group_id, "MediaPostGroup.group_id")
		else:
			group_id = 0
		...
		if raw_story_posts != null:
			story_posts = _parse_int_array(raw_story_posts, "MediaPostGroup.story_posts")
		else:
			story_posts = []
	...
	func validate() -> Array[String]:
		...
		if group_id == null:
			errors.append("MediaPostGroup.group_id is required")
...
class StoryPosts:
	...
	func _init(data: Dictionary = {}) -> void:
		...
		if raw_story_id != null:
			story_id = _parse_int(raw_story_id, "StoryPosts.story_id")
		else:
			story_id = 0
		...
		if raw_posts != null:
			posts = _parse_int_array(raw_posts, "StoryPosts.posts")
		else:
			posts = []
	...
	func validate() -> Array[String]:
		...
		if story_id == null:
			errors.append("StoryPosts.story_id is required")
...
class SocialMediaPost:
	...
	func _init(data: Dictionary = {}) -> void:
		...
		if raw_post_id != null:
			post_id = _parse_int(raw_post_id, "SocialMediaPost.post_id")
		else:
			post_id = 0
		...
		if raw_content_text != null:
			content_text = str(raw_content_text)
		else:
			content_text = ""
	...
	func validate() -> Array[String]:
		...
		if post_id == null:
			errors.append("SocialMediaPost.post_id is required")
